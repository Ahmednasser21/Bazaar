...
import com.iti.itp.bazaar.mainActivity.productInfo.OnClickListner
import com.iti.itp.bazaar.mainActivity.productInfo.OnColorClickListner
import com.iti.itp.bazaar.mainActivity.productInfo.view.AvailableSizesAdapter.AvailbleSizesViewHolder

class AvailableColorAdapter(var onClick: OnColorClickListner) :
    ListAdapter<AvailableColor, AvailableColorAdapter.AvailbleColorsViewHolder>(
        AvailableColorDiffUtill()
    ) {
