...
import com.iti.itp.bazaar.mainActivity.addressFragment.viewModel.AddressViewModel
import com.iti.itp.bazaar.mainActivity.addressFragment.viewModel.AddressViewModelFactory
        ...
        MaterialAlertDialogBuilder(requireContext())
            ...
            .setPositiveButton("Delete") { _, _ ->
                if (address.default == true){
                    showMessage("You can't delete your default address.")
